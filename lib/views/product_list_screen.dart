...
import 'package:task1/controllers/cart_controller.dart';
import 'package:task1/controllers/product_controller.dart';
// import 'package:getx_sqflite/utils/localization_service.dart';
import 'package:task1/views/add_product_screen.dart';
import 'package:task1/views/cart_screen.dart';
import 'package:task1/views/my_drawer.dart';
              ...
              builder: (controller) {
                return Row(
                  ...
                  children: [
                    ...
                    Text(
                      ": \R\p ${controller.totalPrice.toPrecision(2)}",
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                "\R\p ${controller.products[index].price}",
                                style: TextStyle(
                                  fontSize: 20,
                                ),
                              ),
